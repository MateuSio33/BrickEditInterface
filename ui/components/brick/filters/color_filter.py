...
from ui.components.brick.filters.base_filter import FilterMode, FilterResult, BaseFilter
...
class ColorFilter(BaseFilter):
    ...
    def __init__(self, mw: 'BrickEditInterface', mode: FilterMode):
        ...
        self.color_le.editing_finished.connect(self.update_color)
        ...
        self.color_layout.addWidget(self.copy_color_hex, stretch=100)
    ...
    def update_color(self):
        self.color = QColor(self.color_le.get_text().strip())
